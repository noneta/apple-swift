...
function(add_swift_library name)
  ...
  cmake_parse_arguments(ASL
                        "${ASL_options}"
                        "${ASL_single_parameter_options}"
                        "${ASL_multiple_parameter_options}"
                        ${ARGN})
  set(ASL_SOURCES ${ASL_UNPARSED_ARGUMENTS})

  translate_flags(ASL "${ASL_options}")

  if(NOT ASL_SHARED AND NOT ASL_STATIC)
    message(FATAL_ERROR "Either SHARED or STATIC must be specified")
  endif()

  _add_swift_library_single(${name}
                            ${name}
                            ${ASL_SHARED_keyword}
                            ${ASL_STATIC_keyword}
                            ${ASL_FORCE_BUILD_OPTIMIZED_keyword}
                            ${ASL_SOURCES}
                            SDK
