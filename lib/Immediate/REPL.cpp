...
public:
  static llvm::ConversionResult ConvertFromUTF8(const char **sourceStart,
    ...
    return llvm::ConvertUTF8toUTF16(
        ...
        reinterpret_cast<llvm::UTF16 *>(targetEnd), flags);
  }
  ...
  static llvm::ConversionResult ConvertToUTF8(const wchar_t **sourceStart,
                                              ...
                                              char *targetEnd,
                                              llvm::ConversionFlags flags) {
    return llvm::ConvertUTF16toUTF8(
        ...
        reinterpret_cast<llvm::UTF8 *>(targetEnd), flags);
  }
};
...
public:
  static llvm::ConversionResult ConvertFromUTF8(const char** sourceStart,
    ...
    return llvm::ConvertUTF8toUTF32(
        ...
        reinterpret_cast<llvm::UTF32 *>(targetEnd), flags);
  }
  ...
  static llvm::ConversionResult ConvertToUTF8(const wchar_t** sourceStart,
                                        ...
                                        char* targetEnd,
                                        llvm::ConversionFlags flags) {
    return llvm::ConvertUTF32toUTF8(
